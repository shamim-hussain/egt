...
from lib.data.datasets.zinc_full import EigenDataset
from lib.models.zinc_full.dc import DCEigTransformer
from lib.training.schemes.scheme_base import BaseEigModelScheme
from lib.training.schemes.zinc._eval import ZINCEval


class ZincFullDCEig(ZINCEval, BaseEigModelScheme):
